...
EVENTS = [
    dict(title="Afrobeats Night Live", category="Music", date=_day(3), startTime="20:00", endTime="23:59",
         ...
         pinClicks=184, directionClicks=42, status="Published", createdAt=_day(-14), updatedAt=_day(-2), history=_history(20, 6)),
    dict(title="Buea Community Football Cup", category="Sports", date=_day(6), startTime="09:00", endTime="17:00",
         ...
         pinClicks=96, directionClicks=31, status="Published", createdAt=_day(-10), updatedAt=_day(-3), history=_history(12, 4)),
    dict(title="Startup Business Summit", category="Business", date=_day(12), startTime="08:30", endTime="16:00",
         ...
         pinClicks=143, directionClicks=55, status="Published", createdAt=_day(-21), updatedAt=_day(-5), history=_history(16, 5)),
    dict(title="Cultural Heritage Festival", category="Culture", date=_day(9), startTime="11:00", endTime="20:00",
         ...
         pinClicks=221, directionClicks=78, status="Published", createdAt=_day(-30), updatedAt=_day(-4), history=_history(28, 8)),
    dict(title="Rooftop Party: Neon Skyline", category="Nightlife", date=_day(2), startTime="22:00", endTime="04:00",
         ...
         pinClicks=310, directionClicks=121, status="Published", createdAt=_day(-8), updatedAt=_day(-1), history=_history(40, 12)),
    dict(title="Neighbourhood Cleanup Day", category="Community", date=_day(5), startTime="07:00", endTime="12:00",
         ...
         pinClicks=58, directionClicks=19, status="Published", createdAt=_day(-6), updatedAt=_day(-1), history=_history(8, 3)),
    dict(title="Sunset Acoustic Session", category="Music", date=_day(15), startTime="17:30", endTime="21:00",
         ...
         pinClicks=47, directionClicks=12, status="Unpublished", createdAt=_day(-4), updatedAt=_day(-1), history=_history(6, 2)),
    dict(title="Akwa Street Food Carnival", category="Culture", date=_day(20), startTime="12:00", endTime="22:00",
         ...
         pinClicks=132, directionClicks=44, status="Published", createdAt=_day(-12), updatedAt=_day(-2), history=_history(18, 6)),
]
